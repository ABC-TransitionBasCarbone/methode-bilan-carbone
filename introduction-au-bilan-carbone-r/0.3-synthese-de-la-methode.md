...
* [x] The Deliverables from Step 4 - Accounting:
  ...
  * The documentation of the emission factors used, and of the spend-based emission factors (specific and non-specific) along with their sources [(collection matrix)](../4-comptabilisation/4.3-methode-de-selection-des-facteurs-demission.md#matrice-de-collecte-des-donnees);
